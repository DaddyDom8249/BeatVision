...
export default {async fetch(r:Request,e:any){
  ...
  return json(r,e,{ok:false,status:'unsupported_path',error:'Unsupported Arena provider path.',request_id:id},404);
}};
